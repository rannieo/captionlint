...
export const resultFindings: ResultFinding[] = [
  ...
  },
  {
    ...
    line: "87",
    category: "Structure",
    message: "Cue line count exceeds preset maximum (3 > 2).",
    timecode: "00:03:10,200 --> 00:03:12,000",
    cue: "However we must consider\nthe alternatives carefully\nbefore moving on.",
  },
  {
    id: "3",
    severity: "ERROR",
    line: "112",
    category: "Structure",
    message: "Orphaned word on last line — consider rebalancing.",
  ...
  },
  {
    ...
    line: "156",
    category: "Vocabulary",
    message: "Protected term may be split across lines: 'CaptionLint'.",
    timecode: "00:05:22,300 --> 00:05:24,100",
    cue: "Welcome to CaptionLint\nplatform for all your needs.",
  },
];
