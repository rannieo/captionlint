...
export default function SettingsPage() {
  ...
  return (
    <WorkspaceShell>
      <WorkspaceTopbar
        left={
          <span className="text-sm font-semibold text-zinc-100">Workspace Settings</span>
        }
        rightSlot={
      ...
      <main className="min-h-screen overflow-y-auto bg-[#0B0F14] px-4 pb-16 pt-20 md:px-6">
        <div className="mx-auto w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div className="sticky top-20 hidden h-fit space-y-2 lg:block">
              <a href="#profile" className="block rounded border-l-2 border-[#22C55E] bg-[#111827] px-3 py-2 text-sm font-medium text-white">
                Profile Context
              </a>
              {featureFlags.showApiKeys ? (
                <a href="#api" className="block rounded px-3 py-2 text-sm font-medium text-zinc-400 transition-colors hover:bg-[#1F2937] hover:text-white">
                  API Authentication
                </a>
              ) : null}
              <a href="#usage" className="block rounded px-3 py-2 text-sm font-medium text-zinc-400 transition-colors hover:bg-[#1F2937] hover:text-white">
                Resource Usage &amp; Plan
              </a>
              <a href="#preferences" className="block rounded px-3 py-2 text-sm font-medium text-zinc-400 transition-colors hover:bg-[#1F2937] hover:text-white">
                Global Preferences
              </a>
            </div>
            ...
            <div className="space-y-12 pb-24 lg:col-span-2">
                ...
                <div className="rounded-xl border border-[#1F2937] bg-[#111827] p-6">
                  <div className="mb-8 flex items-center gap-6">
                    <div className="relative grid size-20 place-items-center rounded-full border border-[#1F2937] bg-zinc-800 text-xl font-semibold text-zinc-200">
                      {firstName?.[0] ?? "U"}
                      {lastName?.[0] ?? "S"}
                      <button className="absolute bottom-0 right-0 grid size-7 place-items-center rounded-full border border-[#1F2937] bg-[#0B0F14] text-zinc-200 transition-colors hover:text-[#22C55E]">
                        ✎
                      </button>
                    </div>
                    <div className="flex items-center gap-2">
                      <Button variant="outline" className="border-[#1F2937] bg-[#0B0F14]">
                        Upload New
                      </Button>
              ...
              {featureFlags.showApiKeys ? (
                <section id="api" className="scroll-mt-24">
                  ...
                  <div className="overflow-hidden rounded-xl border border-[#1F2937] bg-[#111827]">
                    <div className="flex items-center justify-between border-b border-[#1F2937] bg-[#1F2937] p-4">
                      <div>
                    ...
                    <div className="divide-y divide-[#1F2937]">
                      {[
                        ...
                        <div key={apiKey.key} className="flex items-center justify-between p-4 hover:bg-[#1F2937]">
              ...
              <section id="usage" className="scroll-mt-24">
                ...
                <div className="rounded-xl border border-[#1F2937] bg-[#111827] p-6">
                  <div className="mb-6 flex items-start justify-between">
                    ...
                    <span className="rounded border border-[#1F2937] bg-[#1F2937] px-2 py-1 text-xs text-zinc-300">Active</span>
                  </div>
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="h-2 overflow-hidden rounded-full border border-[#1F2937] bg-[#1F2937]">
              ...
              <section id="preferences" className="scroll-mt-24">
                ...
                <div className="divide-y divide-[#1F2937] overflow-hidden rounded-xl border border-[#1F2937] bg-[#111827]">
                  {[
                    {
